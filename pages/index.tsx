  ...
  return (
    <div className="container">
            ...
            <li>
              <form>
                ...
                <button className="nav__search icon-button" type="submit">
                  <Image src="/img/search.svg" width="25px" height="25px" alt="search" />
                </button>
              </form>
            </li>
          </ul>
      ...
      <header className="hero">
        <Image className="hero__background" layout="fill" sizes="(min-width: 750px) 1440px, 100vw" src="/img/pope-francis.png" alt="Pope Francis" />
        <div className="max-centered">
      ...
      <div className="max-centered">
        ...
        <aside className="banner banner-bottom" role="doc-tip" aria-label="Submit a name">
          <Image sizes="(min-width: 750px) 1440px, 100vw" className="banner__background" src="/img/bg-people.png" layout="fill" alt="" role="none" />
          <div className="banner__left">
